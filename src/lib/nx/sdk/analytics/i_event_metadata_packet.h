...
class IEventMetadataPacket0 : public Interface<IEventMetadataPacket0, ICompoundMetadataPacket0>
{
  public:
    ...
    {
        return makeId("nx::sdk::analytics::IEventMetadataPacket");
    }

    /** Called by at() */
  protected:
    virtual const IEventMetadata *getAt(int index) const override = 0;

  public:
    Ptr<const IEventMetadata> at(int index) const
    {
...
class IEventMetadataPacket : public Interface<IEventMetadataPacket, IEventMetadataPacket0>
{
  public:
    static auto interfaceId()
    {
        return makeId("nx::sdk::analytics::IEventMetadataPacket1");
    }
