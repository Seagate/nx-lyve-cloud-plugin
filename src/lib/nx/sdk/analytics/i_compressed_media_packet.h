...
class ICompressedMediaPacket : public Interface<ICompressedMediaPacket, IDataPacket0>
{
  public:
    ...
    {
        return makeId("nx::sdk::analytics::ICompressedMediaPacket");
    }
     ...
     *
     * For the metadata, check the [Onvif
     * documentation](https://www.onvif.org/specs/stream/ONVIF-Streaming-Spec-v210.pdf).
     */
    ...
    /** Called by context() */
  protected:
    virtual const IMediaContext *getContext() const = 0;
    /**
     * @return Pointer to the codec context, or null if not available.
     */
  public:
    Ptr<const IMediaContext> context() const
    {
