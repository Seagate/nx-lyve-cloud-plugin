...
class IObjectTrackBestShotPacket0 : public Interface<IObjectTrackBestShotPacket0, IMetadataPacket0>
{
  public:
    ...
    {
        return makeId("nx::sdk::analytics::IObjectTrackBestShotPacket");
    }
...
class IObjectTrackBestShotPacket1 : public Interface<IObjectTrackBestShotPacket1, IObjectTrackBestShotPacket0>
{
  public:
    static auto interfaceId()
    {
...
class IObjectTrackBestShotPacket : public Interface<IObjectTrackBestShotPacket, IObjectTrackBestShotPacket1>
{
  public:
    static auto interfaceId()
    {
